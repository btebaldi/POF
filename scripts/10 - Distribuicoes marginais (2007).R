...
writexl::write_xlsx(x = tbl2,
                    path = sprintf(dirparth_mask, "DistMarg_X1_Domicilios_2007.xlsx"))
...
print(tbl2)
writexl::write_xlsx(x = tbl2,
                    path = sprintf(dirparth_mask, "DistMarg_X2_GastoRefri_2007.xlsx"))
...
tb_idade$Idade_Classe <- cut(tb_idade$Idade, breaks = c(13,20,30,40,50,60,70,80,90,100,110),)
...
writexl::write_xlsx(x = tb_idade,
                    path = sprintf(dirparth_mask, "DistMarg_X3_Tabela_idade_2007.xlsx"))
...
writexl::write_xlsx(x = tb_genero,
                    path = sprintf(dirparth_mask, "DistMarg_X4_Tabela_genero_2007.xlsx"))
...
writexl::write_xlsx(x = tb_estudo,
                    path = sprintf(dirparth_mask, "DistMarg_X5_Tabela_estudo_2007.xlsx"))
rm(list = c("tb_estudo"))
...
writexl::write_xlsx(x = tbl_grupos,
                    path = sprintf(dirparth_mask, "DistMarg_X6_Tabela_grupos_2007.xlsx"))
