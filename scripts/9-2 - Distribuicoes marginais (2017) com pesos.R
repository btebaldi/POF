...
writexl::write_xlsx(x = tbl2,
                    path = sprintf(dirparth_mask, "POF 2017 - DistMarg_X1_Domicilios.xlsx"))
...
print(tbl2)
writexl::write_xlsx(x = tbl2,
                    path = sprintf(dirparth_mask, "POF 2017 - DistMarg_X2_GastoRefri.xlsx"))
...
writexl::write_xlsx(x = tb_idade,
                    path = sprintf(dirparth_mask, "POF 2017 - DistMarg_X3_Tabela_idade.xlsx"))
...
writexl::write_xlsx(x = tb_genero,
                    path = sprintf(dirparth_mask, "POF 2017 - DistMarg_X4_Tabela_genero.xlsx"))
...
writexl::write_xlsx(x = tb_estudo,
                    path = sprintf(dirparth_mask, "POF 2017 - DistMarg_X5_Tabela_estudo.xlsx"))
rm(list = c("tb_estudo"))
