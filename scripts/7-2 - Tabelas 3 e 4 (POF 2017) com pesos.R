...
writexl::write_xlsx(x = tbl_Bebidas_UC_Produto,
                    path = "./database/Export/Tabelas Finais com peso/POF 2017 - Tabela3.xlsx")
...
writexl::write_xlsx(x = tbl_Gasto_Bebidas_UC_Produto,
                    path = "./database/Export/Tabelas Finais com peso/POF 2017 - Tabela4.xlsx")
...
writexl::write_xlsx(x = tbl_6,
                    path = "./database/Export/Tabelas Finais com peso/POF 2017 - Tabela6.xlsx")
...
writexl::write_xlsx(x = tbl_7,
                    path = "./database/Export/Tabelas Finais com peso/POF 2017 - Tabela7.xlsx")
